 ...
 */
{
  class Details {
    ...
    init() {
      //this.DOM.body = this.DOM.querySelector("body");
      this.DOM.group = this.DOM.details.querySelector(".details__group");
      this.DOM.bgUp = this.DOM.details.querySelector(".details__bg--up");
      this.DOM.bgDown = this.DOM.details.querySelector(".details__bg--down");
      this.DOM.header = this.DOM.details.querySelector("details__header");
      this.DOM.img = this.DOM.group.querySelector(".details__img");
      ...
      this.DOM.dates = this.DOM.details.querySelector(".details__dates");
      this.DOM.description = this.DOM.details.querySelector(
        ".details__description"
      );
      this.DOM.close = this.DOM.details.querySelector(".details__close");
      this.DOM.magnifier = this.DOM.group.querySelector(".details__magnifier");
    ...
    open(data) {
      ...
      this.DOM.img.style.transform = `translateX(${rect.productImgRect.left -
        rect.detailsImgRect.left}px) translateY(${rect.productImgRect.top -
        rect.detailsImgRect.top}px) scaleX(${rect.productImgRect.width /
        rect.detailsImgRect.width}) scaleY(${rect.productImgRect.height /
        rect.detailsImgRect.height})`;
      this.DOM.img.style.opacity = 1;
      this.DOM.group.style.opacity = 1;
  ...
  class Item {
    constructor(el) {
      ...
      this.info = {
        deco: this.DOM.product.querySelector(".product__color").innerHTML,
        ...
        description: this.DOM.product.querySelector(".product__description")
          .innerHTML,
        dates: this.DOM.product.querySelector(".product__dates").innerHTML
      };
